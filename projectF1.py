...
def home_page():
    ...
    Label(main_frame,text="VOICE",font="Helvetica 30 bold",bg="light blue", fg="white").place(x=1015,y=160)
    Label(main_frame,text="SPEED",font="Helvetica 30 bold",bg="light blue", fg="white").place(x=1365,y=160)
    ...
    volume_label = Label(main_frame,font="Helvetica 30 bold",bg="light blue", fg="white",text="Volume")
    ...
    Label(main_frame,text="Choose prefered language",font="Helvetica 30 bold",bg="light blue", fg="white").place(x=970,y=385)
...
def audiobook_page():
   ...
   # global pause variable
    ...
    toggle_menu_frame.lift()
    main_frame.propagate(False)
    lb=Label(main_frame,text="Listen to your pdf file as an audiobook",font="Helvetica 25 bold",fg='blue',bg='white',bd=2,relief='solid')
    lb.place(x=470,y=40)
    ...
    lb=Label(main_frame,text='enter page number',font='Helvetica 10',bg='white')
